...
void main() {
  group('SimplePuzzleLayoutDelegate', () {
    late ChamaeleonPuzzleLayoutDelegate layoutDelegate;
    ...
    setUp(() {
      layoutDelegate = ChamaeleonPuzzleLayoutDelegate();
      ...
      testWidgets(
        ...
        expect(
          find.byWidgetPredicate(
            (widget) =>
                widget is ChamaeleonStartSection && widget.state == state,
          ),
          findsOneWidget,
        );
      });
    ...
    group('endSectionBuilder', () {
      testWidgets(
        ...
        expect(find.byType(ChamaeleonPuzzleShuffleButton), findsNothing);
      });
      ...
      testWidgets(
        ...
        expect(find.byType(ChamaeleonPuzzleShuffleButton), findsOneWidget);
      });
    ...
    group('SimpleStartSection', () {
      testWidgets('renders PuzzleName', (tester) async {
        await tester.pumpApp(
          SingleChildScrollView(
            child: ChamaeleonStartSection(state: state),
          ),
          themeBloc: themeBloc,
        );
      ...
      testWidgets('renders SimplePuzzleTitle', (tester) async {
        ...
        expect(
          find.byWidgetPredicate(
            (widget) =>
                widget is ChamaeleonPuzzleTitle &&
      ...
      testWidgets(
        ...
        expect(
          find.byType(ChamaeleonPuzzleShuffleButton),
          findsOneWidget,
        );
      });
    });
    ...
    group('SimplePuzzleTile', () {
      ...
      testWidgets(
        ...
        await tester.tap(find.byType(ChamaeleonPuzzleTile));
      ...
      group('matches golden file', () {
        ...
        testWidgets('given default state', (tester) async {
          ...
          await expectLater(
            find.byType(ChamaeleonPuzzleTile),
    ...
    group('SimplePuzzleShuffleButton', () {
      testWidgets(
        ...
        await tester.tap(find.byType(ChamaeleonPuzzleShuffleButton));
    ...
    test('supports value comparisons', () {
      expect(
        ChamaeleonPuzzleLayoutDelegate(),
