  ...
  group('PuzzleView', () {
    ...
    group('PuzzleMenu', () {
      testWidgets(
        ...
        final themes = [ChamaeleonTheme(), GreenDashatarTheme()];
    ...
    group('PuzzleMenuItem', () {
      ...
      setUp(() {
        ...
        themes = [ChamaeleonTheme(), tappedTheme];
        themeState = ThemeState(themes: themes, theme: ChamaeleonTheme());
        ...
        testWidgets(
          ...
          await tester.pumpApp(
            PuzzleMenuItem(
              ...
              themeIndex: themes.indexOf(ChamaeleonTheme()),
            ),
            themeBloc: themeBloc,
            puzzleBloc: puzzleBloc,
          );
