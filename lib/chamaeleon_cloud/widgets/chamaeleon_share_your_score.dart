...
class ChamaeleonshareYourScore extends StatelessWidget {
  /// Displays buttons to share a score of the completed puzzle.
  const ChamaeleonshareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final ChamaeleonShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('chamaelon_share_your_score'),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      key: const Key('chamaelon_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        key: const Key('chamaelon_share_your_score_message'),
                        textAlign: textAlign,
