...
import 'package:very_good_slide_puzzle/chamaeleon_cloud/widgets/chamaeleon_score.dart';
import 'package:very_good_slide_puzzle/chamaeleon_cloud/widgets/chamaeleon_share_dialog_animated_builder.dart';
import 'package:very_good_slide_puzzle/chamaeleon_cloud/widgets/chamaeleon_share_your_score.dart';
...
/// Displays a Chamaeleon share dialog with a score of the completed puzzle
/// and an option to share the score using Twitter or Facebook.
class ChamaeleonShareDialog extends StatefulWidget {
  /// Displays a Chamaeleon share dialog with a score of the completed puzzle
  /// and an option to share the score using Twitter or Facebook.
  const ChamaeleonShareDialog({
    Key? key,
  ...
  @override
  State<ChamaeleonShareDialog> createState() => _ChamaeleonShareDialogState();
}

class _ChamaeleonShareDialogState extends State<ChamaeleonShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('chamaeleon_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('chamaeleon_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('chamaeleon_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: ChamaeleonShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('chamaeleon_share_dialog_close_button'),
