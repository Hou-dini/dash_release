...
/// The animation builder of ChamaeleonShareDialog.
class ChamaeleonShareDialogAnimatedBuilder extends StatelessWidget {
  /// The animation builder of ChamaeleonShareDialog.
  const ChamaeleonShareDialogAnimatedBuilder({
    Key? key,
  ...
  final ChamaeleonTransitionBuilder builder;
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          ChamaeleonShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef ChamaeleonTransitionBuilder = Widget Function(
  BuildContext context,
  Widget? child,
  ChamaeleonShareDialogEnterAnimation animation,
);

class ChamaeleonShareDialogEnterAnimation {
  ChamaeleonShareDialogEnterAnimation(this.controller)
