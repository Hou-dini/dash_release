...
class PuzzleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Shuffle Puzzle if theme is SimpleTheme;
    final shufflePuzzle = theme is ChamaeleonTheme;
            ...
            child: TextButton(
              ...
              onPressed: () {
                ...
                context.read<PuzzleBloc>().add(
                      PuzzleInitialized(
                        shufflePuzzle: theme is ChamaeleonTheme,
                      ),
                    );
              },
